...
class Settings:
    ...
    sim_balance: float = float(os.getenv("SIM_BALANCE", "1000"))  # Padrao $1000 para paper trading
    ...
    # LTM (Liquidity Time Model) settings
    use_ltm: bool = os.getenv("USE_LTM", "false").lower() == "true"
    ltm_policy_path: str = os.getenv("LTM_POLICY_PATH", "ltm_policy.yaml")
    ltm_use_decay: bool = os.getenv("LTM_USE_DECAY", "true").lower() == "true"
